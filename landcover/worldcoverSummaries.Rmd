...
Visualize. Full image is [here](outputs/WorldcoverBasedLCsProportionOfAreas_gridwise_colFull.jpg) (**LARGE** file!).
...
# pAreaProps
# ggsave("outputs/WorldcoverBasedLCsProportionOfAreas_gridwise_colFull.jpg",  plot = pAreaProps, width = 10000, height = 10000, units = "px", limitsize = FALSE)
```
